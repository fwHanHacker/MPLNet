...
SPLIT_FILES = {
    'trainval':
    ['label_data_0114.json', 'label_data_0115.json'],
    'train': ['label_data_0114.json'],
    'val': ['label_data_0115.json'],
    'test': ['label_data_0116.json'],
}

@DATASETS.register_module
class Cpld01(BaseDataset):
    ...
    def load_annotations(self):
        self.logger.info('Loading cpld_01 annotations...')
        self.data_infos = []
        max_lanes = 0
