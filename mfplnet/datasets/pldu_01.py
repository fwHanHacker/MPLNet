...
SPLIT_FILES = {
    ...
    'train': ['label_data_0114.json', 'label_data_0115.json'],
    'val': ['label_data_0116.json', 'label_data_0117.json'],
    'test': ['label_data_0118.json'],
}


@DATASETS.register_module
class Pldu01(BaseDataset):
    ...
    def load_annotations(self):
        self.logger.info('Loading pldu_01 annotations...')
        self.data_infos = []
        max_lanes = 0
