...
class LaneEval(object):
    ...
    @staticmethod
    def lanes_to_mask(lanes, y_samples, img_width, img_height):
        ...
        for lane in lanes:
            ...
            if len(points) > 1:
                for i in range(len(points) - 1):
                    ...
                    cv2.line(mask, pt1, pt2, color=1, thickness=70)
        return mask
    ...
    def bench(pred, gt, y_samples, running_time):
        ...
        mask_gt = LaneEval.lanes_to_mask(gt, y_samples, LaneEval.img_width, LaneEval.img_height)
        mask_pred = LaneEval.lanes_to_mask(pred, y_samples, LaneEval.img_width, LaneEval.img_height)
        iou = LaneEval.calculate_iou(mask_pred, mask_gt)
    ...
    def bench_one_submit(pred_file, gt_file):
        ...
        accuracy, fp, fn, iou_total = 0., 0., 0., 0.0
        ...
        for pred in json_pred:
            ...
            try:
                a, p, n, iou = LaneEval.bench(pred_lanes, gt_lanes, y_samples,
                                              run_time)
            except BaseException as e:
                raise Exception('Format of lanes error.')
            accuracy += a
        ...
        mean_iou = iou_total / num if num > 0 else 0.0
...
if __name__ == '__main__':
    ...
    try:
        ...
        result_json, avg_acc, avg_iou = LaneEval.bench_one_submit(sys.argv[1], sys.argv[2])
        print(result_json)
