...
def _create_efficientvit(model_cfg, pretrained=False, frozen_stages=0, distillation=False, fuse=False,
...
class EfficientViTWrapper(nn.Module):
    def __init__(self,
                 ...
                 out_channel=128,
                 cfg=None):
        super(EfficientViTWrapper, self).__init__()
        self.cfg = cfg

        if model_name == 'EfficientViT_M0':
            self.model = _create_efficientvit(EfficientViT_m0, pretrained, frozen_stages, distillation, fuse,
                                              pretrained_path)
        elif model_name == 'EfficientViT_M1':
            self.model = _create_efficientvit(EfficientViT_m1, pretrained, frozen_stages, distillation, fuse,
                                              pretrained_path)
        elif model_name == 'EfficientViT_M2':
            self.model = _create_efficientvit(EfficientViT_m2, pretrained, frozen_stages, distillation, fuse,
                                              pretrained_path)
        elif model_name == 'EfficientViT_M3':
            self.model = _create_efficientvit(EfficientViT_m3, pretrained, frozen_stages, distillation, fuse,
                                              pretrained_path)
        elif model_name == 'EfficientViT_M4':
            self.model = _create_efficientvit(EfficientViT_m4, pretrained, frozen_stages, distillation, fuse,
                                              pretrained_path)
        elif model_name == 'EfficientViT_M5':
            self.model = _create_efficientvit(EfficientViT_m5, pretrained, frozen_stages, distillation, fuse,
                                              pretrained_path)
        else:
            raise ValueError(f"Unsupported EfficientViT model name: {model_name}")
