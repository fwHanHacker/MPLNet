...
backbone = dict(
    type='MIT_EfficientViTWrapper',
    model_name='EfficientViT_MIT_L0',
    pretrained=False,
    out_indices=(2, 3, 4),
    frozen_stages=0,
    norm_eval=False,
...
work_dirs = "work_dirs/mfpl/mit_efficientvit_l0_cpld_01"
...
your_actual_train_samples = 833
total_iter = (your_actual_train_samples // batch_size + 1) * epochs
